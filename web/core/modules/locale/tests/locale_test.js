...
Drupal.t(
  'Context Single Quoted t',
  {},
  { context: 'Context string single quoted' },
);
Drupal.t(
  'Context Double Quoted t',
  {},
...
Drupal.formatPlural(
  1,
  'Context Unquoted plural',
  'Context Unquoted @count plural',
  {},
...
Drupal.formatPlural(
  ...
  'Context Single Quoted @count plural',
  {},
  { context: 'Context string single quoted' },
);
Drupal.formatPlural(
  ...
  'Context Double Quoted @count plural',
  {},
  { context: 'Context string double quoted' },
);
...
Drupal.formatPlural(
  1,
  'Context !key Args plural',
  'Context !key Args @count plural',
  { '!key': 'value' },
  { context: 'Context string' },
);
